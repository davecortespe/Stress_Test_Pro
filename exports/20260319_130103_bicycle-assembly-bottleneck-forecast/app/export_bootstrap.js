window.__EXPORT_BUNDLE_DATA__ = {
  "dashboardConfig": {
    "appTitle": "Bicycle Assembly Bottleneck Forecast",
  ...
  "vsmGraph": {
    "metadata": {
      "name": "Bicycle Assembly Bottleneck Forecast",
      "units": "minutes",
    ...
    "assumptions": [
      {
        "id": "strict-001",
        "severity": "warning",
        "text": "The VSM title is not visible in the image; model metadata was inferred as Bicycle Assembly Bottleneck Forecast."
      },
      {
        "id": "strict-002",
        "severity": "info",
  ...
  "compiledForecastModel": {
    "version": "0.3.0",
    "generatedAt": "2026-03-19T16:59:46.903Z",
    "metadata": {
      "name": "Bicycle Assembly Bottleneck Forecast",
      "units": "per-hour",
