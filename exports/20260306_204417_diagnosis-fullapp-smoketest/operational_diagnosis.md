...
Sterile BRR QA is taking demand at about 0.0 units/hr but only clearing about 0.0 units/hr, so arrivals are outrunning service and the queue cannot normalize.

**4. Downstream Effects**
Throughput is running about 53% below required rate, WIP has built to roughly 19 units, total lead time is now about 343218.2 minutes, and operators should expect more expediting, rescheduling, and service risk if this state persists.
