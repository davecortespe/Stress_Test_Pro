window.__EXPORT_BUNDLE_DATA__ = {
  ...
  "operationalDiagnosis": {
    "status": "overloaded",
    "statusSummary": "Form & Filling is no longer clearing work at the required rate. The system is effectively overloaded, so queue and WIP growth will continue until load is reduced or capacity is added.",
    "primaryConstraint": "Form & Filling is the current constraint, and downstream congestion at Inspection is preventing that queue from clearing cleanly.",
    "constraintMechanism": "Form & Filling is not failing in isolation. Inspection is also congested, so downstream WIP is not clearing fast enough and the blockage propagates back upstream.",
    "downstreamEffects": "Throughput is running about 3% below required rate, WIP has built to roughly 148 units, and operators should expect more expediting, rescheduling, and service risk if this state persists.",
    "economicInterpretation": "This is creating hidden capacity loss of roughly 3% versus required output. The likely business impact is overtime pressure, slower inventory availability, and missed throughput that has to be recovered later.",
    "recommendedAction": "Stabilize the handoff between Form & Filling and Inspection first. Clear downstream WIP before releasing more work, and rebalance labor by queue pressure instead of fixed headcount.",
